          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-6 shadow-2xl mb-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <button
                ...
                className="rounded-2xl bg-emerald-500 hover:bg-emerald-400 text-black font-bold px-6 py-3 transition shadow-lg shadow-emerald-500/20"
              >
                {loading ? "Scanning..." : "Analyze Market"}
              </button>
            </div>
          </div>
          ...
          {data && (
            <>
              <div className="grid grid-cols-1 md:grid-cols-4 gap-5 mb-8">
                ...
                <div className="rounded-3xl bg-white/5 border border-white/10 p-6">
                  <p className="text-slate-400 text-sm">Weighted Score</p>
